...
for (i in 1:41) {
  ...
  for (j in 1:41) {
    ...
    # Appel de la fonction dessinSol2 et mise à jour de la matrice coral
    res <- dessinSol2(ic = c(M = 0.005, C = 0.995, P = 95, R=2),
                      parms = c(a = 0.1, beta = 100,gamma = 0.8, d = 0.44, r = 1, f = fish,
                                s = 0.49, ca = -3.21, cb = 3.65, kmax = 17.745,
...
dessinSol3 <- function(ic=c(M=0.001,C=0.999,P=0.75,R=2), times=seq(1:100),func=interaction_coral3, 
                      parms=c(a=0.1,
                              d=0.44,
                              r=1,
                              f=0.2,
...
for (i in 1:41) {
  ...
  for (j in 1:41) {
    ...
    # Appel de la fonction dessinSol2 et mise à jour de la matrice coral
    res <- dessinSol3(ic = c(M = 0.001, C = 0.56, P = 1, R=rugo),
...
# Créer le graphique avec la matrice en tant que données
image(1:nrow(coral), 1:ncol(coral), t(coral), col = plasma(100),
