...
2. Les perturbation des récif corail tel que les épidemie et le blanchiment des coraux ne sont pas pris en compte. 
3. L'effort de pêche influence proportionnelement la dynamique de population parrofishs. 
4. Les technique de pêche n'ont pas d'influence sur l'effort de peche.
5. Après un oragan, la recolonisation du corail et des algues se fait rapidement.
6. Les récifs revient à un équilibre semblable à celui d'avant l'ouragan en termes de structure et de composition.
7. Les ouragans n'ont pas d'effets directs significatifs sur l'abondance ou la croissance des parrofishs.
8. La distribution des coraux, des algues macroscopiques et des poissons perroquets sont homogene dans l'espace.
...
dessinSol3 <- function(ic=c(M=0.001,C=0.56,P=0.95,R=2), times=seq(1:30),func=interaction_coral3, 
                      parms=c(a=0.1,
                              d=0.44,
                              r=1,
                              f=0.2,
...
for (i in 1:41) {
  ...
  for (j in 1:41) {
    ...
    res <- dessinSol3(ic = c(M = 0.001, C = 0.56, P = 0.95, R=rugo),
