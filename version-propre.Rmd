...
5. Après un oragan, le gazon d'algues colonise immédiatement tout l'espace libre.
6. Les ouragans n'ont pas d'effets directs significatifs sur l'abondance ou la croissance des parrofishs.
8. La distribution des coraux, des algues macroscopiques et des poissons perroquets dans l'espace n'a pas d'impact sur leur dynamique. 
...
dessinSol3 <- function(ic=c(M=0.001,C=0.56,P=0.95), 
