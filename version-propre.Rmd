...
image(1:nrow(coral), 1:ncol(coral), t(coral), col = plasma(40),
      xlab = "effort de pêche", ylab = "R initiale", main = "Graphique de C finale selon la Rugosité initiale et l'effort de pêche après 30 ans",axes=F);axis(side = 1, at = 1:ncol(coral), labels = col_names);axis(side = 2, at = 1:nrow(coral), labels = row_names)
```
