...
$\frac{dC}{dts} = (rTC - dC - aMC)\frac{1}{s}$   
$\frac{dM}{dts} = (asMC - \frac{\alpha \frac{P}{\beta}M}{M + Y} - \gamma MY)\frac{1}{s}$  
$\frac{dP}{dts} = P(1 - \frac{P}{\beta K(M+T,R)} - fP$  
$\frac{dR}{dts} = h_GC(3-R) - h_E(1-C)(R-1)$  
$\frac{dY}{dts} = 1 - M - C$  
...
10. Un ouragan affecte affecte l'ensemble de l'écosysteme de fasson égale.  
