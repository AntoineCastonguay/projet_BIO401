...
#### Article de référence : Une approche basée sur un modèle pour déterminer les effets à long terme de multiples facteurs de stress en interaction sur les récifs coralliens.

###### Blackwood, J.C., Hastings, A. and Mumby, P.J. (2011), A model-based approach to determine the long-term effects of multiple interacting stressors on coral reefs. Ecological Applications, 21: 2722-2733. https://doi.org/10.1890/10-2195.1
...
Comment la résilience des récifs coralliens varie-t-elle en fonction la surpêche et des ouragans?
...
|:--:|:----:|:--------------|
| s         | 0.49   | Taux de croissance des parrofishs par année |
...
La capacité de support de l'environnement pour le parrofishs prendre en compte l'abondance des algues, qui constituent leur nourriture, ainsi que la qualité de l'habitat K(M + T, R).  
...
Modèle Nondimentionner par rapport taux de croissance des parrofish par année:  
...
6. Les ouragans n'ont pas d'effets directs significatifs sur l'abondance ou la croissance des parrofishs. 
...
# Fonction pour le modele deterministe du l'interaction entre le corail, les marcoalgue et les parrofishs avec une rugosité fixe.
