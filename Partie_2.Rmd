...
Les résultats ont démontrer tres peux de fluctuation selon l'intensité de ouragan dans le cas des effort de peche faible et moyenne. Il quand meme possible d'observer plus d'instabilité a fort impact. Avec un effort de peche élever, l'impact des ouragan est toutefois plus prononcer. Plus l'impact des ouragan est important, plus la rugosité necessaire a la résilence des corail est importante. 
...
```
Dans ces résultat, il est possible de remarquer un leger tendance. Plus l'impact des ouragan est elever, plus l'effort de peche doit etre réduit pour permetre au corail un résilence. 

# Discution 

Nos résutat on montrer tres peu d'impact des ouragant sur les récif corail à l'exeption a de tres au niveau d'effort de peche. 
