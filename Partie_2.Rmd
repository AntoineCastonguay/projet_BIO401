...
Un premier élément à noter est qu'une tendance générale peut être observée, indiquant que plus l'impact est élevé, plus la situation des coraux est instable. Cette observation s'observe aussi dans les graphiques des l'écart-type. D'ailleur, on peut noter que l'étendue des écart-type est large. Pour une même simulation les écarts maximum peuveuent aller jusqu'à 30%. 
Dautre part, il est interessant de noter qu'avec un effort de peche plus important, la rugosité minimal pour une résilence des coraux augmente. 
...
Dans le cadre des analyses entre la rugosité et l'impact des ouragane avec trois niveau d'effort de peche plusieur élément sont ressortie des résultat. Un premier élément est que plus l'impact est élevé, plus la situation des coraux est instable. Cela est cohérent avec le modele puisque les impact maximum peuveut affecter enormement les populations des coraux. Toutefois, il est interessant de noter que cette tendance est légère dans les cas d'effort de peche faible et moyenne. L'impact des ouragant se fait vraiment resentir quand on a un effort de peche élever. Avec un niveau de peche éléver, cela a un impact important sur la population de poisson peroquet. Cette diminution va venir impacter la rugosité minimal pour qu'il est résilience des coraux. Ainsi, lors d'ouragan a fort impact, la rugosité est plus fortement affecter et a plus tendance a franchir le seuil limite de résilence des coraux. 

Un deuxieme élément interessant est que les trois simulations possèdent une large étendue d'écart-type, les écarts maximum allant jusqu'à 30% pour une même simulation. Un étendue large d'écartype démontre une intabilité au niveau des population avec les même condition de départ. Ainsi, 
