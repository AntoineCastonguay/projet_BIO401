...
## Résultat
Dans un premier lieux, la fonction de la simulation du modele XXX a été dévelloper. La fonction prend en argument la rugosité de départ (R0), l'effort de pêche (f), la probabilité qu'un ouragan survienne dans la zone des récit corailien par an (lamda), le niveau d'impact de l'ouragan (impact) et la duré des pas de temps sachant que 1 équivaut a faire un pas de temps d'une année (dt).
```{r}
...
graph.imageCIR(fishing = 0.1, freq = 1/15, it=5, pas = 0.5)
graph.imageCIR(fishing = 0.4, freq = 1/15, it=5, pas = 0.5)
graph.imageCIR(fishing = 0.7, freq = 1/15, it=5, pas = 0.5)
...
graph.imageRIR(fishing = 0.1, freq = 1/15, it=5, pas = 0.5)
graph.imageRIR(fishing = 0.4, freq = 1/15, it=5, pas = 0.5)
graph.imageRIR(fishing = 0.7, freq = 1/15, it=5, pas = 0.5)
