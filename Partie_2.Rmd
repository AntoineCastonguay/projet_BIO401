...
graph.imageCIR(fishing = 0.1, freq = 1/15, it=5, pas = 0.1)
graph.imageCIR(fishing = 0.4, freq = 1/15, it=5, pas = 0.1)
graph.imageCIR(fishing = 0.7, freq = 1/15, it=5, pas = 0.1)
...
graph.imageRIR(fishing = 0.1, freq = 1/15, it=5, pas = 0.1)
graph.imageRIR(fishing = 0.4, freq = 1/15, it=5, pas = 0.1)
graph.imageRIR(fishing = 0.7, freq = 1/15, it=5, pas = 0.1)

```

Les résultats ont démontrer tres peux de fluctuation selon l'intensité de ouragan dans le cas des effort de peche faible et moyenne. Toutefois, avec un effort de peche élever, 
...
graph.imageCIf(R0=2.8,freq = 1/15,it=10,pas = 0.1)
# graph.imageCIf(R0=1.4,freq = 1/15,it=2,pas = 0.25)
# graph.imageCIf(R0=1.6,freq = 1/15,it=2,pas = 0.25)
# graph.imageCIf(R0=1.8,freq = 1/15,it=2,pas = 0.25)
# graph.imageCIf(R0=2.0,freq = 1/15,it=2,pas = 0.25)
# graph.imageCIf(R0=2.2,freq = 1/15,it=2,pas = 0.25)
# graph.imageCIf(R0=2.4,freq = 1/15,it=2,pas = 0.25)
# graph.imageCIf(R0=2.6,freq = 1/15,it=2,pas = 0.25)
# graph.imageCIf(R0=2.8,freq = 1/15,it=2,pas = 0.25)
...
```
```{r}
graph.imageCRf <- function(freq,it=10,pas=0.1){
  ...
  image.plot(x = x_values, y = y_values, t(matC), col = viridis(20), 
             ...
             main=c("moyenne de C finale",paste(c("fréq:1/",1/l),collapse = "")))
  image.plot(x = x_values, y = y_values, t(matsd), col = viridis(20),
             xlab = "Effort de pêche", ylab = "Rugosité initiale",
             main=c("écart-type de C finale",paste(c("fréq:1/",1/l),collapse = "")))
}
graph.imageCRf(freq = 1/15,it=20,pas = 0.2)
```
